<?php
     ...
     * @link        https://github.com/emdadul38/php-online-exam-api/App/Controller/UserController.php
     * @license     MIT
     */
    class UserController extends Controller {
        ...
        */
        ...
        public function testAuth($request, $response)
        {
            $Response = [];
            ...
            try {
                ...
                $Response['status'] = 500;
                $Response['message'] = 'Sorry, An unexpected error occured and your user could be retrieved.';
                $Response['data'] = [];
